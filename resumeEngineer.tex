...
\section{Summary}
Experienced full-stack developer proficient in JavaScript, Typescript, React, Node.js, and
...
\textbf{Tools \& Technologies {$\parallel$} \normalfont{ HTML, CSS, React.js,
            ...
            GitHub, VS Code, WSL, Docker, Linux, Kanban, Agile}}

\section{FullStack Academy Capstone Projects}

\subsection{Alley Cat: Retro Side-Scroller Game {$\parallel$}{Project Manager \& Developer}
